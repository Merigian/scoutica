...
import { reviewApplication } from "@/server/actions/castings";
...
export function ApplicationActions({ applicationId, locale }: ApplicationActionsProps) {
  const router = useRouter();
  const [loading, setLoading] = useState(false);
  const lang = locale === "en" ? "en" : "it";
  const t = useTranslations("components.applicationActions");
