  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1440px] px-6 lg:px-12">
        ...
        <div className="-mx-6 flex snap-x snap-mandatory gap-4 overflow-x-auto overscroll-x-contain select-none md:select-auto px-6 md:mx-0 md:grid md:snap-none md:grid-cols-3 md:overflow-visible md:px-0 lg:gap-6 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          {doors.map((d, i) => (
            <Reveal
              key={d.href}
              delay={i * 90}
