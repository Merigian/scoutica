...
export function FeaturedMarquee({ children }: FeaturedMarqueeProps) {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div
        ref={trackRef}
        className="relative overflow-x-auto overflow-y-hidden [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden touch-pan-x overscroll-x-contain select-none"
      >
